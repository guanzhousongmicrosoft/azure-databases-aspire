...
- DocumentDB `0.113.0` upstream release detected on 2026-09-07 (container tags `pg15-0.113.0`, `pg16-0.113.0`, `pg17-0.113.0`).
- DocumentDB `0.114.0` upstream release detected on 2026-09-07 (container tags `pg15-0.114.0`, `pg16-0.114.0`, `pg17-0.114.0`).
- DocumentDB `0.116.0` upstream release detected on 2026-09-07 (container tags `pg15-0.116.0`, `pg16-0.116.0`, `pg17-0.116.0`).
